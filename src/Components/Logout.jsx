...
import { PASSENGER_FAILURE, PASSENGER_LOGOUT } from "../Redux/Passenger/actionTypes";
import { driverLogout } from "../Redux/Rider/actions";
import { DRIVER_LOGOUT } from "../Redux/Rider/actionTypes";
const Logout = () => {
    const dispatch=useDispatch()
    function handleLogout(){
     console.log('invoke me for logout')
     dispatch(passengerLogout()).then(res=>{console.log(res);dispatch({type:PASSENGER_LOGOUT})})
  ...
  <MenuList>
    ...
    <Icon viewBox="0 0 24 24" color="RGBA(0, 0, 0, 0.92)">
      ...
      <span style={{color:'black',marginLeft:10}} onClick={handleLogout}>Passenger Logout</span>
    </MenuItem>
    <MenuItem minH='40px'>
    <Icon viewBox="0 0 24 24" color="RGBA(0, 0, 0, 0.92)">
            <path
      ...
      <span style={{color:'black',marginLeft:10}} onClick={handleDriverLogout}>Driver Logout</span>
    </MenuItem>
  </MenuList>
</Menu>
  )
